...
def step_given_open_target_circle(context):
    context.driver = webdriver.Chrome()  # Ensure you have ChromeDriver set up
    context.driver.get("https://www.target.com/circle")
    context.driver.implicitly_wait(10)  # Wait for elements to load

@when('I check the benefit cells')
def step_when_check_benefit_cells(context):
    context.benefit_cells = context.driver.find_elements(By.CSS_SELECTOR, '.BenefitCell')  # Adjust selector as needed
